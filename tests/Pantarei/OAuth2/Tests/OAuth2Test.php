 ...
 */
class OAuth2Test extends OAuth2WebTestCase
{
  public function testAuthorizationCodeGrant()
  {
    ...
    $this->assertEquals('http://democlient1.com/redirect_uri', $auth_response->getSchemeAndHttpHost() . $auth_response->getBaseUrl() . $auth_response->getPathInfo());
    ...
    $result = $this->app['oauth2.orm']->getRepository($this->app['oauth2.entity']['Codes'])->findOneBy(array(
      'client_id' => 'http://democlient1.com/',
      'code' => $code,
    ));
    ...
    $result = $this->app['oauth2.orm']->getRepository($this->app['oauth2.entity']['AccessTokens'])->findOneBy(array(
      'token_type' => 'bearer',
      'client_id' => 'http://democlient1.com/',
    ...
    $result = $this->app['oauth2.orm']->getRepository($this->app['oauth2.entity']['RefreshTokens'])->findOneBy(array(
      'token_type' => 'bearer',
      'client_id' => 'http://democlient1.com/',
