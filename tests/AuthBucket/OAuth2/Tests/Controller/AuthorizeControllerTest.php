...
class AuthorizeControllerTest extends WebTestCase
{
    public function testCreateActionJson()
    {
        ...
        $crawler = $client->request('POST', '/api/v1.0/authorize.json', array(), array(), array(), $content);
    ...
    public function testCreateActionXml()
    {
        ...
        $client = $this->createClient();
        $crawler = $client->request('POST', '/api/v1.0/authorize.xml', array(), array(), array(), $content);
    ...
    {
        $client = $this->createClient();
        $crawler = $client->request('GET', '/api/v1.0/authorize/1.json');
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'json');
    ...
    {
        $client = $this->createClient();
        $crawler = $client->request('GET', '/api/v1.0/authorize/1.xml');
    ...
    public function testUpdateActionJson()
    {
        ...
        $client = $this->createClient();
        $crawler = $client->request('PUT', "/api/v1.0/authorize/${id}.json", array(), array(), array(), $content);
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'json');
        $this->assertEquals($clientIdUpdated, $response['clientId']);

        $client = $this->createClient();
        $crawler = $client->request('GET', "/api/v1.0/authorize/${id}.json");
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'json');
        $this->assertEquals($clientIdUpdated, $response['clientId']);
    }
    ...
    public function testUpdateActionXml()
    {
        ...
        $client = $this->createClient();
        $crawler = $client->request('PUT', "/api/v1.0/authorize/${id}.xml", array(), array(), array(), $content);
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'xml');
        $this->assertEquals($clientIdUpdated, $response['clientId']);

        $client = $this->createClient();
        $crawler = $client->request('GET', "/api/v1.0/authorize/${id}.xml");
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'xml');
        $this->assertEquals($clientIdUpdated, $response['clientId']);
    }
    ...
    public function testDeleteActionJson()
    {
        ...
        $id = $response['id'];
        $client = $this->createClient();
        $crawler = $client->request('DELETE', "/api/v1.0/authorize/${id}.json");
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'json');
    ...
    public function testDeleteActionXml()
    {
        ...
        $id = $response['id'];
        $client = $this->createClient();
        $crawler = $client->request('DELETE', "/api/v1.0/authorize/${id}.xml");
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'xml');
        $this->assertEquals(null, $response['id']);
        $this->assertEquals($clientId, $response['clientId']);
    ...
    {
        $client = $this->createClient();
        $crawler = $client->request('GET', '/api/v1.0/authorize.json');
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'json');
    ...
    {
        $client = $this->createClient();
        $crawler = $client->request('GET', '/api/v1.0/authorize.xml');
        $response = $this->app['serializer']->decode($client->getResponse()->getContent(), 'xml');
        $this->assertEquals('51b2d34c3a661b5e111a694dfcb4b248', $response[0]['clientId']);
    }
}
